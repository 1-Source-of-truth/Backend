...
public class ModelExportController {
    ...
    public Workspace get() {
        ...
        Component requirementAnalyzer = backend.addComponent("RequirementAnalyzer", "Analyzes the codebase and reads test-reports and reports on the results", "Maven module");
        Component buildingBlocks = backend.addComponent("BuildingBlocks", "Analyzes the codebase and generates a Structurizr model", "Maven module");
        Component launcher = backend.addComponent("Launcher", "Launches the application and is used for common property definitions", "Maven module");
